...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"ee4564c4-d8c5-4284-b632-ca06cf8bc78b\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [34 x i8] c"com.companyname.carsharinghamburg\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 570, ; number_of_dso_cache_entries
	i32 33555267, ; android_runtime_jnienv_class_token
	i32 100672218, ; jnienv_initialize_method_token
	i32 100672217, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.7 = internal constant [32 x i8] c"libaot-SQLitePCLRaw.core.dll.so\00", align 16
...
@__DSOCacheEntry_name.25 = internal constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Maps.dll.so\00", align 16
...
@__DSOCacheEntry_name.38 = internal constant [34 x i8] c"libaot-Microsoft.Maui.Maps.dll.so\00", align 16
...
@__DSOCacheEntry_name.54 = internal constant [32 x i8] c"libaot-CarSharingHamburg.dll.so\00", align 16
@__DSOCacheEntry_name.55 = internal constant [40 x i8] c"libaot-SQLitePCLRaw.batteries_v2.dll.so\00", align 16
...
@__DSOCacheEntry_name.61 = internal constant [41 x i8] c"libaot-CommunityToolkit.Maui.Core.dll.so\00", align 16
...
@__DSOCacheEntry_name.67 = internal constant [16 x i8] c"libe_sqlite3.so\00", align 16
@__DSOCacheEntry_name.68 = internal constant [40 x i8] c"libaot-Microsoft.Maui.Essentials.dll.so\00", align 16
@__DSOCacheEntry_name.69 = internal constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Basement.dll.so\00", align 16
...
@__DSOCacheEntry_name.80 = internal constant [43 x i8] c"libaot-Microsoft.Maui.Controls.Maps.dll.so\00", align 16
@__DSOCacheEntry_name.81 = internal constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 16
@__DSOCacheEntry_name.82 = internal constant [20 x i8] c"libSystem.Native.so\00", align 16
@__DSOCacheEntry_name.83 = internal constant [68 x i8] c"libaot-Microsoft.Extensions.DependencyInjection.Abstractions.dll.so\00", align 16
...
; dso_cache
@dso_cache = local_unnamed_addr global [570 x %struct.DSOCacheEntry] [
	; 0
	...
	; 68
	%struct.DSOCacheEntry {
		i64 2293046283015299488, ; hash 0x1fd2897200a821a0, from name: CarSharingHamburg.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 69
	%struct.DSOCacheEntry {
	...
	; 87
	%struct.DSOCacheEntry {
		i64 2721888841397499209, ; hash 0x25c6177ae598f549, from name: aot-CarSharingHamburg.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 119
	%struct.DSOCacheEntry {
		i64 3700964155822562727, ; hash 0x335c774a8a41dda7, from name: libaot-CarSharingHamburg
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 152
	%struct.DSOCacheEntry {
		i64 4947616339104129706, ; hash 0x44a976d8c93862aa, from name: CarSharingHamburg
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([68 x i8], [68 x i8]* @__DSOCacheEntry_name.83, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 178
	%struct.DSOCacheEntry {
	...
	; 274
	%struct.DSOCacheEntry {
		i64 8831500194759882755, ; hash 0x7a8fcaa2c674b803, from name: libaot-CarSharingHamburg.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 327
	%struct.DSOCacheEntry {
		i64 10618880149962416749, ; hash 0x935dd73c32f4e26d, from name: aot-CarSharingHamburg
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
